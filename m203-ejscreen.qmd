...
To begin, click on the EJScreen link here: <https://www.epa.gov/ejscreen>. On that page, along with resources on how to use EJScreen, you will see a blue, bold text labeled “Launch the EJScreen Tool.” You can also go straight to the mapper using this link:[https://ejscreen.epa.gov/mapper/.](https://ejscreen.epa.gov/mapper/)
...
Search for 'TEMPO NO2' <https://gis.earthdata.nasa.gov/portal/home/item.html?id=0252904123a74e74a7cff652d52a5b19>[![](images/image27-01.png)](https://gis.earthdata.nasa.gov/portal/home/item.html?id=0252904123a74e74a7cff652d52a5b19)
...
![](images/ezgif-4acdcb73a594b.gif){fig-align="center"}

After the Living Atlas layer is successfully added, it can be used in combination with EJScreen's built-in indicators. This allows for deeper analysis by overlaying environmental justice data with external geospatial information, such as pollution levels or land use patterns. By integrating both datasets, users can gain a more comprehensive view of the factors influencing environmental justice in a particular area. Another resource for EJI by CDC: <https://www.atsdr.cdc.gov/place-health/php/eji/eji-explorer.html> To learn more about TEMPO: Air Quality Monitoring from Space by NASA using TEMPO, check out this StoryMap: <https://storymaps.arcgis.com/stories/01e82aefbc8b4d7a951fe089c818bc0c>

## Using the "Explore Charts" Function to Generate Data for Analysis
